...
for f in $( ls $filename_no_extension ); do
    ...
    convert -bordercolor black -border 1x1 -fuzz 20% -trim -density 300 $filename_no_extension/$the_file -depth 8 -strip -background white -alpha Off $filename_no_extension/tiff/$the_file_noext.tif
